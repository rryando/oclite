...
export const Definitions = {
  ...
  session_tab_new: keybind("alt+t", "Open a new tab (multi-tab mode)"),
  session_tab_close: keybind("alt+w", "Close the active tab (multi-tab mode)"),
  session_tab_cycle: keybind("alt+]", "Cycle to the next tab (multi-tab mode)"),
...
export const CommandMap = {
  ...
  session_tab_cycle: "session.tab.cycle",
