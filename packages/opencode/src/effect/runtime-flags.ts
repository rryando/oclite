...
export class Service extends ConfigService.Service<Service>()("@opencode/RuntimeFlags", {
  ...
  experimentalCrossProjectSpawn: enabledByExperimental("OPENCODE_EXPERIMENTAL_CROSS_PROJECT_SPAWN"),
  ...
  leanTools: Config.boolean("OPENCODE_LEAN_TOOLS").pipe(Config.withDefault(true)),
