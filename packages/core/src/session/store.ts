...
export const databaseNode = LayerNode.unbound(Database.Service, Node.tags.values.global)
export const node = makeGlobalNode({ service: Service, layer, deps: [databaseNode] })
